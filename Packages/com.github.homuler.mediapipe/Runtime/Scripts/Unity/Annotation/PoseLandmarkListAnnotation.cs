...
#pragma warning restore IDE0065
  ...
  public sealed class PoseLandmarkListAnnotation : HierarchicalAnnotation
  {
    ...
    private void Start()
    {
      ...
      // 修正: デバッグ用の点と線を透明にして見えなくする
      _leftLandmarkColor = Color.clear;
      _rightLandmarkColor = Color.clear;
      ...
      // 修正: 線の色と幅も見えなくする
      _connectionListAnnotation.SetColor(Color.clear);
      _connectionListAnnotation.SetLineWidth(0f);
    }
